  ...
  template: `
    ...
    >
      <li class="mfb-component__wrap">
        <a
          class="mfb-component__button--main {{mainButtonClass}}"
        ...
        <span class="mfb-component__main-icon--resting " [innerHTML]="iconClass | sanitizeHtml">
        </span>
        <!-- the main button icon visibile when the user is hovering/interacting with the menu -->
        <span class="mfb-component__main-icon--active "  [innerHTML]="activeIconClass | sanitizeHtml">
        </span>
        </a>
